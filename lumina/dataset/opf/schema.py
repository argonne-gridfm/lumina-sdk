...
| 1 | `pg` | Active power generation | MW |
| 2 | `pmin` | Minimum active power output | MW |
| 3 | `pmax` | Maximum active power output | MW |
| 4 | `qg` | Reactive power generation | MVAr |
| 5 | `qmin` | Minimum reactive power output | MVAr |
| 6 | `qmax` | Maximum reactive power output | MVAr |
