#!/bin/bash
#SBATCH -A lrn087
#SBATCH -J lumina-200M-al-smoke
#SBATCH -o smoke-200M-al-%j.log
#SBATCH -e smoke-200M-al-%j.log
#SBATCH -p batch
#SBATCH -q normal
#SBATCH -t 00:30:00
#SBATCH -N 1
...
export LUMINA_LOGGING_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/logs/lumina-200M-al-smoke-${SLURM_JOB_ID}
export LUMINA_CHECKPOINT_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/checkpoints/lumina-200M-al-smoke-${SLURM_JOB_ID}
export LUMINA_CONFIG=configs/config.frontier.rocm713.al.smoke.200M.yaml
export LUMINA_MODEL_CONFIG=configs/model/heterognn_200M.yaml
