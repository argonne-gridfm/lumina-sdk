...
export LUMINA_LOGGING_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/logs/lumina-100M-240K-al-${SLURM_JOB_ID}
export LUMINA_CHECKPOINT_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/checkpoints/lumina-100M-240K-al-${SLURM_JOB_ID}
