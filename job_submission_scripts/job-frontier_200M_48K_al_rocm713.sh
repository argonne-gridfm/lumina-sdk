...
export LUMINA_LOGGING_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/logs/lumina-200M-48K-al-${SLURM_JOB_ID}
export LUMINA_CHECKPOINT_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/checkpoints/lumina-200M-48K-al-${SLURM_JOB_ID}
...
export LUMINA_GROUP_IDS="0 1 2 3"
