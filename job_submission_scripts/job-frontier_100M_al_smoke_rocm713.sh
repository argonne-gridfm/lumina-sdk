#!/bin/bash
#SBATCH -A lrn087
#SBATCH -J lumina-100M-al-smoke
#SBATCH -o smoke-100M-al-%j.log
#SBATCH -e smoke-100M-al-%j.log
#SBATCH -p batch
#SBATCH -q normal
#SBATCH -t 00:30:00
#SBATCH -N 1
...
export LUMINA_LOGGING_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/logs/lumina-100M-al-smoke-${SLURM_JOB_ID}
export LUMINA_CHECKPOINT_DIR=/lustre/orion/lrn087/proj-shared/mlupopa/checkpoints/lumina-100M-al-smoke-${SLURM_JOB_ID}
